...
class PublicCompanyProfilePage extends StatefulWidget {
  ...
  @override
  State<PublicCompanyProfilePage> createState() =>
      _PublicCompanyProfilePageState();
}
  ...
  Future<void> carregarPerfil() async {
    try {
      final response = await http.get(
        Uri.parse(
          '${ApiConfig.baseUrl}/empresas/by-candidatura/${widget.candidaturaId}',
        ),
        ...
        child: Column(
          children: [
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      ...
                      Text(
                        '$avaliacaoMedia Média de Avaliações',
            ...
            Container(
              ...
              padding: const EdgeInsets.all(24),
              child: Text(
                empresaData?['descricao'] ?? 'Sem descrição.',
